...
urlpatterns = [
    ...
    path('trainings/past/<int:training_id>/', training_details_past, name='training_past'),
    ...
    path('employees/<int:employee_id>/assign', assign_employee, name='assign_employee')
]
